...
void WeaponInit()
{
    ...
    AddWeapon(5, "Elite" , 22 , 0, 0, 187 , 1, 2,1000, 300, 0 , 13, 120, 1000, 0, 0);
    AddWeapon(6, "Five-Seven" , 21 , 0, 0, 187 , 1, 2,750 , 300, 0 , 20, 100, 2000, 0, 0);
    ...
    AddWeapon(35, "AWP" , 50  , 65 , 150, 23 , 3, 1, 4750 , 400, 0 , 10, 30, 2000, 5, 0);
