...
void WeaponInit()
{
    ...
    AddWeapon(1, "USP"   , 24 , 0, 0, 166 , 1, 2, 500, 300, 0 , 12, 100, 10000);
    AddWeapon(2, "Glock" , 21 , 0, 0, 166 , 1, 2, 400, 250, 0 , 20, 120, 10000);
    AddWeapon(3, "Deagle", 34 , 0, 0, 100 , 1, 2, 550, 300, 0 , 7 , 35 , 10000);
    AddWeapon(4, "P228"  , 22 , 0, 0, 166 , 1, 2, 600, 300, 0 , 13, 35 , 10000);
    AddWeapon(5, "Elite" , 22 , 0, 0, 187 , 1, 2,1000, 300, 0 , 13, 120, 10000);
    AddWeapon(6, "Five-Seven" , 21 , 0, 0, 187 , 1, 2,750 , 300, 0 , 20, 100, 10000);
    AddWeapon(50, "Knife", 100, 0, 0, 1   , 1, 2, 0  , 8  , 0 , -1, -1 , 10000);
    //FIXME finish reload
}
